...
export function carsRender({ id, name, color }) {
  carList.insertAdjacentHTML('beforeend', `
    <div className="col-4" id="car${id}">
        ...
        <div>
            <button type="button" class="btn btn-light start-car-btn">Start</button>
            <button type="button" class="btn btn-light stop-car-btn">Stop</button>
        </div>

        <div class='track' style='position: relative; height: 87px'>
        ...
        <br>
        <button type="button" class="btn btn-light btn-edit">Select car</button>
        <button type="button" class="btn btn-light btn-delete">Delete car</button>
        <br>
        <br>
    </div>
    `);
...
/*
    <div class='finish' style='left:${FINISH}px;'>
        FIHISH
    </div>
*/
